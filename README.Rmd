...
-   `shinyspring::create_new_project()` creates a new default project
    ...
    -   *app_type* : minimal (bare minimum app) , standard (defaukt) , full_demo (full app with all sweetmods visible)
...
-   Step 4 : Create your custom module for you application with `shinyspring::create_module("my_custom_module")` . Implement the module
