...
ui <- bs4Dash::dashboardPage(
  ...
  sidebar = dashboardSidebar(
    ...
    sidebarMenu(
     ...
     menuItem(
          "Introduction" ,
          tabName = "intro_mod_tab",
          icon = icon("university")
        ),

     menuItem(
          "Core Analysis" ,
          tabName = "core_analysis_tab",
          icon = icon("university")
        ),
  ...
  body = dashboardBody(
    tabItems(
      create_tab_module(tab_name = "intro_mod_tab" ,
                        module_name = "intro_mod" ,
                        module_function = "demo_ui" ) ,
      create_tab_module(tab_name = "core_analysis_tab" ,
...
server <- function(input, output , session) {
      demo_server(id = "intro_mod" , control = controller)
      demo_server(id = "core_analysis" , control = controller)
